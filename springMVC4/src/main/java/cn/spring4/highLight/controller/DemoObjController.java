...
//此时放在返回类型前面
    ...
    @RequestMapping(value = "/pathVar/{str}", produces = "text/plain;charset=UTF-8")//演示接受路径参数。访问路径为/test/pathVar/string
    public
    @ResponseBody
...
//演示request参数获取。访问路径为/test/requestParam?id=1
    public
    @ResponseBody
    ...
    @RequestMapping(value = "/obj1", produces = "application/json;charset=UTF-8")//演示解释参数到对象。访问路径为/test/obj1?serial=1&id_string=1&name=xx
    @ResponseBody
    ...
    @RequestMapping(value = "/obj2", produces = "application/json;charset=UTF-8")//演示解释参数到对象。访问路径为/test/obj2?serial=1&id_string=1&name=xx
    @ResponseBody
